...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.controlUi": "Optional Browser UI",
  "gateway.controlUi.enabled": "Optional Browser UI Enabled",
  ...
  "gateway.controlUi.basePath": "Browser UI Base Path",
  "gateway.controlUi.root": "Browser UI Assets Root",
  "gateway.controlUi.allowedOrigins": "Browser UI Allowed Origins",
  "gateway.controlUi.dangerouslyAllowHostHeaderOriginFallback":
    "Dangerously Allow Host-Header Origin Fallback",
  "gateway.controlUi.allowInsecureAuth": "Insecure Browser UI Auth Toggle",
  "gateway.controlUi.dangerouslyDisableDeviceAuth": "Dangerously Disable Browser UI Device Auth",
