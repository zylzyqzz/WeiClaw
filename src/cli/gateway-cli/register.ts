      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["weiclaw gateway run", "Run the gateway in the foreground."],
            ["weiclaw gateway status", "Show service status and probe reachability."],
            ["weiclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["weiclaw gateway call health", "Call a gateway RPC method directly."],
