...
const STEP_LABELS: Record<string, string> = {
  ...
  build: "Building",
  "ui:build": "Building optional browser UI assets",
  "ui:build (post-doctor repair)": "Restoring optional browser UI assets",
  "ui assets verify": "Validating optional browser UI assets",
