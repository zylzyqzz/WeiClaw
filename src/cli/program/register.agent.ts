...
${formatHelpExamples([
  ['weiclaw agent --to +15555550123 --message "status update"', "Start a new session."],
  ['weiclaw agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'weiclaw agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'weiclaw agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['weiclaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'weiclaw agent --agent ops --message "Generate report" --deliver --reply-channel telegram --reply-to "@ops_reports"',
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['weiclaw agents set-identity --agent main --name "WeiClaw" --emoji "🟥W"', "Set name + emoji."],
  ["weiclaw agents set-identity --agent main --avatar avatars/weiclaw.png", "Set avatar path."],
  [
    "weiclaw agents set-identity --workspace ~/.openclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "weiclaw agents set-identity --identity-file ~/.openclaw/workspace/IDENTITY.md --agent main",
