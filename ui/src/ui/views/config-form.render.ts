...
export const SECTION_META: Record<string, { label: string; description: string }> = {
  ...
  channels: {
    label: "Channels",
    description: "Telegram-first channel settings for WeiClaw Private",
  },
  messages: { label: "Messages", description: "Message handling and routing settings" },
  commands: { label: "Commands", description: "Custom slash commands" },
  hooks: { label: "Hooks", description: "Webhooks and event hooks" },
  skills: { label: "Skills", description: "Skill packs and capabilities" },
  tools: { label: "Tools", description: "Private-mode tool defaults, exec access, and automation" },
  gateway: { label: "Gateway", description: "Gateway server settings (19789, auth, Control UI)" },
  ...
  models: { label: "Models", description: "OpenAI-compatible model configurations and defaults" },
